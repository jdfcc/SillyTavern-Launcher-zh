...
cls
echo %blue_fg_strong%[ĞÅÏ¢]%reset% %cyan_fg_strong%SillyTavern LauncherµÄĞÂ¸üĞÂ¿ÉÓÃ!(Ã»ÊÔ¹ı¸üĞÂ£¬¸üĞÂºó¿ÉÄÜÊ§È¥ºº»¯)%reset%
...
cls
set /p tabbyapimodelurl="(ÊäÈë0È¡Ïû )²åÈëÄ£ĞÍ URL: "
...
cls
set /p civitaimodelid="ÊäÈë0È¡Ïû)²åÈëÄ£ĞÍID: "
...
echo 1. °²×° 7-Zip
echo 2. È¡Ïû
set /p zip_choice="ÄãÏëÏÖÔÚ°²×°7-Zip Âğ? (Õâ½«ĞèÒªÔÚ°²×°ºóÖØĞÂÆô¶¯Launcher): "
